...
| `.github/workflows/ci.yml` | Solo commenti: dichiarata divergenza Python 3.11 CI vs 3.12.3 WSL; aggiornata descrizione T9a/T9c nel Job Summary e nel gate sandbox |
| `.claude/agents/memoria_revisore.md` | Aggiunta riga #59 (APPROVATO, nessuna lezione nuova) |
| `reports/stato_progetto.md` | 9 punti canonici aggiornati con dati live: review counter #59, R-ci-summary chiuso, R-ci-openrouter chiuso+storia errori, lezione T9b, PR #40/#41 in riga CI, head origin=5, §7 venv WSL aggiornato, errore "247 PASS WSL 2026-07-19" dichiarato, azioni senza traccia git |
| `reports/ultimo_report.md` | Report task di questa sessione (inclusa CI finale) |
