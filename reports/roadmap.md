...
1. **FASE 2.5 — Summarizzazione cronologia** (prerequisito VPS h24; vedi sotto).
2. **FASE 3 — Interfaccia vocale: Whisper (STT) e successive** (vedi sotto).
3. **FASE 4.5 — Task scheduler autonomo** (prerequisito Jarvis reale; vedi sotto).
