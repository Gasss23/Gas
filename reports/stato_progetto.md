...
> Ultimo aggiornamento: **2026-07-27** (doc-only: allineamento CI line PR #44–#49 + verifica coerenza post-PR #47 su stato_progetto.md)
...
- ✅ **Bonifica branch remoti ESEGUITA** (2026-07-22): da **27 head a 5**. I 22 branch mergiati in `main` sono stati cancellati da origin. Restano `main` + **4 NON mergiati**, tutti da NON cancellare senza verifica: `feature/crm-dup-detect` (fetta 3 landata su main via rewrite PR #47 → superata), `fix/crm-idemp-diario`, `fix/review44-riserve-AC`, `claude/phone-gas-development-10svqc`. Metodo di misura: `git ls-remote --heads origin`. Azione eseguita da terminale/UI: **nessuna traccia in git**, registrata qui. ⛔ CANCELLAZIONE = azione umana, MAI da sessione agente.
