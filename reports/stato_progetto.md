...
CI GitHub Actions — ultimi run su main (tutti ✅ SUCCESS): PR #32 merge `f2679a4` (2026-07-20, CI `29775144603`) · PR #27 merge `21548f74` (2026-07-19, CI `29695063005`) · PR #25 merge `c609e31` (2026-07-19, CI `29664233791`) · PR #24 merge `fd3d47a` (2026-07-18) · PR #23 merge `2f1e015` (2026-07-18).
...
- 🟡 **R-crm-1b** — Fetta email ✅ + merge umano ✅ (review #47+#48, 2026-07-14) + **fetta 2 idempotenza diario ✅** (review #57, 2026-07-19, PR #27 → merge `21548f74`, CI `29695063005` ✅): token stabile `[k=<email>|<id_lo>-<id_hi>]` embedded nella descrizione; pre-check SELECT prima di ogni `append_diario`; FAIL-OPEN §9; T57h/i/j. Resta 🟡 per: telefono (fetta 3).
...
- ⛔ **F7 — BLOCCATA su prerequisito 'accesso SSH al VPS ripristinato'**: non è una task rimandata, non può partire. La strada 1 (riga `.venv/` nel `.gitignore` della copia VPS) richiede SSH.
