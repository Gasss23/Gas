...
FASE 1 ✅, FASE 2 ✅ e **FASE 2.5** ✅ chiuse. **57 review** completate (ultima #57, 2026-07-19, R-crm-1b fetta 2, APPROVATO CON RISERVE — riserva docstring chiusa in-session). Suite WSL locale (2026-07-19, fix/crm-idemp-diario): **247 PASS, 0 FAIL, 2 SKIP** (T9a/T9c no API keys; T57h/i/j nuovi ✅). Hook suite: **10 PASS**. CI GitHub Actions — ultimi run su main (tutti ✅ SUCCESS): PR #27 merge `21548f74` (2026-07-19, CI `29695063005`) · PR #25 merge `c609e31` (2026-07-19) · PR #24 `fd3d47a` (2026-07-18).
...
- 🟡 **R-crm-1b** — Fetta email ✅ + merge umano ✅ (review #47+#48, 2026-07-14) + **fetta 2 idempotenza diario ✅** (review #57, 2026-07-19, PR #27 → merge `21548f74` su main, CI `29695063005` ✅): token stabile `[k=<email>|<id_lo>-<id_hi>]` embedded nella descrizione; pre-check SELECT prima di ogni `append_diario`; FAIL-OPEN §9; T57h/i/j. Resta 🟡 per: telefono (fetta 3).
...
- **C** — `.claude/agents/revisore.md`: gate obbligatorio pre-commit motore. **56 review**. Ultima: **#56** (R-hook-jq fix/hook-jq-failloud, 2026-07-19, APPROVATO). Lezioni in `.claude/agents/memoria_revisore.md`. ✅ Backfill #48–#50 ESEGUITO (2026-07-18, PR #24).
