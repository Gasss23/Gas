...
- 🟡 **kernel rifiuta 7×8** (ATTESTATO DAL SUPERVISORE, 2026-08-22): in text-only mode, STT ha reso correttamente `'sette per otto'` → `'7×8'`, ma il kernel non ha calcolato/risposto. Causa probabile: tool aritmetico mancante nella cascata oppure gate troppo conservativo. Non bloccante per il giro audio (giro completo mic→TTS passato). Da investigare nella prossima fetta o prima del VPS.
