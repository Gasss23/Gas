...
- **C** — `.claude/agents/revisore.md`: gate obbligatorio pre-commit motore. **49 review**. Ultima: **#49** (R-crm-1b Fette 2+3, 2026-07-14). Lezioni in `.claude/agents/memoria_revisore.md`.
