...
- **C** — `.claude/agents/revisore.md`: gate obbligatorio pre-commit motore. **57 review**. Ultima: **#57** (R-crm-1b fetta 2 idempotenza diario, 2026-07-19, APPROVATO CON RISERVE). Fonte contatore: numero più alto citato in `.claude/agents/memoria_revisore.md` (`#57`). ⚠️ Il file NON è un registro completo per-review: l'obbligo "una riga per ogni review" è in vigore solo dal 2026-07-16 (#51). Misura 2026-07-22: 100 righe, 29 numeri `#N` distinti, contigui SOLO da #51 a #57; sotto #51 mancano 1–4, 7–18, 20–25, 28, 33–35, 41, 45. Il conteggio "57 review" NON è ricostruibile contando il file ed è ereditato dallo storico. Contare le righe per validare il contatore è un metodo INVALIDO. Lezioni in `.claude/agents/memoria_revisore.md`. ✅ Backfill #48–#50 ESEGUITO (2026-07-18, PR #24).
