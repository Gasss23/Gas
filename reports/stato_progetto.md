...
- 🔴 **Decisione APERTA — SICUREZZA: chiave ElevenLabs esposta in chat (2026-08-02, da handoff #59)**: la chiave API ElevenLabs è stata condivisa nella chat di sessione. Va ruotata immediatamente. Prima di ogni uso runtime: verificare che non sia hardcoded in nessun file sotto `clients/`.
