...
def chat(messages, tools_schema=None):
    ...
    if not response and os.environ.get("GROQ_API_KEY"):
        ...
        try:
            g_res = requests.post(groq_url, headers=groq_headers, json={"model": "openai/gpt-oss-120b", "messages": formatted_messages, "temperature": 0.2, "reasoning_effort": "low"}, timeout=15)
